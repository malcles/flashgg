...
namespace flashgg {
    ...
    public:
        ...
        virtual void getInfoFromLastSelection( float& ) = 0;
        virtual void getAllInfoFromLastSelection( vector<float>& ) = 0;
        virtual void getAllInfoFromLastSelectionForVtxIdx(vector<float>&  , unsigned int )= 0;
